...
public class TreeSetExam {
   ...
   public static void main(String[] args) {
      ...
      for(Integer i: scores) {      // scores 안에 있는 값을 정렬된 순서대로 하나씩 꺼내겠다
      ...
      NavigableSet<Integer> rangeSet = scores.tailSet(80, true);      // scores에서 80 이상인 값들만 모아놓은 집합
      ...
      // 범위1 <= 값 < 범위2
      // 70에서 90 사이가 몇 개인지
      NavigableSet<Integer> rangeSet2 = scores.subSet(70, true, 90, true);   // scores에서 70 이상 90 이하 값들만 모아놓은 집합
